    ...
    public partial class Roominf : Form
    {
        ...
        private void Roominf_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                roomdataGridView.Columns["num"].HeaderText = "商铺编号";
                roomdataGridView.Columns["weizhi"].HeaderText = "商铺区域";
                roomdataGridView.Columns["mingzi"].HeaderText = "商铺名称";
                roomdataGridView.Columns["zhonglei"].HeaderText = "商铺类型";
                roomdataGridView.Columns["mianji"].HeaderText = "商铺面积";
                roomdataGridView.Columns["zhuangxiu"].HeaderText = "装修状况";
                roomdataGridView.Columns["sheshi"].HeaderText = "屋内设施";
                roomdataGridView.Columns["yongtu"].HeaderText = "商铺用途";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (comboBox1.SelectedItem.ToString().Equals("商铺编号"))
                    chaxunfangshi = "num";
                else if (comboBox1.SelectedItem.ToString().Equals("商铺区域"))
                    chaxunfangshi = "weizhi";
                else if (comboBox1.SelectedItem.ToString().Equals("商铺名称"))
                    chaxunfangshi = "mingzi";
                else if (comboBox1.SelectedItem.ToString().Equals("商铺状态"))
